...
t = datestr(t);
t = strrep(t,':','-');
experimentResultsPath = ['Results\Experiment_Various_ST_Values_Bunch_1460B_packets_', int2str(dataRate), '_Mbps_data_rate_', int2str(numSims), '_Simulations_', int2str(numDevs/2), '_pTp_Links_', int2str(simTime), '_secondes_simulation_', t];
